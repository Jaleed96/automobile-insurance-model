...
#     model = GradientBoostingRegressor(n_estimators=112, random_state=0, max_features=6, max_depth=31, min_samples_leaf=30, learning_rate=0.05)
...
# plt.plot(np.arange(76, 77), rf_train_errors, color="green", label="Training errors")
# plt.plot(np.arange(76, 77), rf_cv_errors, color="red", label="Validation errors")
