...
train_y_categorical = train_output.astype('bool')
train_y_categorical = train_y_categorical.astype('int')
train_x_synthetic, train_y_synthetic = sm.fit_sample(train_input, train_y_categorical)

train_input = train_x_synthetic
